...
import com.mksiva.restapi.resource.CountResource;
import com.mksiva.restapi.resource.ResourceCollection;
import com.mksiva.restapi.resource.UserResource;
import com.mksiva.service.UserService;
import com.mksiva.service.exception.UpdatedUserNotFoundException;

/**
 * Created by Siva on 18.8.17.
 */
@RestController
...
public class UserRestController {
    ...
    public ResponseEntity<CountResource> getUsersCount() {

    	return ResponseEntity.ok(
                new CountResource(userService.count())
        );       
    }
